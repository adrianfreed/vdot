...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 509.0, 345.0, 82.0, 22.0 ],
					"text" : "gain-scale $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 478.0, 398.0, 82.0, 22.0 ],
					"text" : "res-transform"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1027.0, 540.0, 82.0, 22.0 ],
					"text" : "gain-scale $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 973.0, 585.0, 82.0, 22.0 ],
					"text" : "res-transform"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 574.0, 82.0, 22.0 ],
					"text" : "gain-scale $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 555.0, 610.0, 82.0, 22.0 ],
					"text" : "res-transform"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 733.0, 610.0, 79.0, 22.0 ],
					"text" : "bang, zlclear"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 38.0, 209.0, 32.5, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 120.0, 123.0, 34.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 924.0, 624.0, 83.0, 22.0 ],
					"text" : "zl 2048 group"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1072.0, 362.0, 82.0, 22.0 ],
					"text" : "gain-scale $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 1074.0, 401.0, 82.0, 22.0 ],
					"text" : "res-transform"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 31.0, 141.0, 56.0, 22.0 ],
					"text" : "delay 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 172.0, 32.5, 22.0 ],
					"text" : "8."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.0, 172.0, 32.5, 22.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 27.0, 77.0, 62.0, 22.0 ],
					"text" : "select 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 87.0, 34.0, 84.0, 22.0 ],
					"text" : "route bang int"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 227.0, 80.0, 22.0 ],
					"text" : "rate-scale $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 637.0, 320.0, 33.0, 22.0 ],
					"text" : "float"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 818.0, 107.0, 33.0, 22.0 ],
					"text" : "float"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 383.0, 172.0, 33.0, 22.0 ],
					"text" : "float"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 258.0, 98.0, 33.0, 22.0 ],
					"text" : "float"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 262.0, 41.0, 76.0, 22.0 ],
					"text" : "unpack f f f f"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "", "list" ],
					"patching_rect" : [ 745.0, 238.0, 466.0, 87.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 767.0, 179.0, 150.0, 33.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "./Synthesizers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
