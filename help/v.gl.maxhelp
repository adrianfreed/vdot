...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 42.0, 135.0, 69.0, 22.0 ],
					"text" : "qmetro 100"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 198.0, 304.0, 278.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 42.0, 92.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 210.0, 75.0, 22.0 ],
					"text" : "o.select /ball"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 41.5, 339.0, 150.0, 100.0 ],
					"text" : "Bouncing Ball\nAdrian Freed 2014\n\nFor the shape descriptors see:\n\no.gl.shapes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 42.0, 177.0, 129.0, 22.0 ],
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 41.5, 241.0, 209.0, 72.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 51.5, 201.0, 27.0, 201.0, 27.0, 9.0, 286.5, 9.0 ],
					"order" : 0,
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 51.0, 324.0, 267.0, 324.0, 267.0, 192.0, 291.5, 192.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 286.5, 174.0, 161.5, 174.0 ],
					"source" : [ "obj-5", 0 ]
				}
